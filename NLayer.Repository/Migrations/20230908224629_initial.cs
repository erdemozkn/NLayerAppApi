    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 9, 9, 1, 46, 28, 878, DateTimeKind.Local).AddTicks(9832), "Kalem 1", 100m, 20, null },
                    { 2, 1, new DateTime(2023, 9, 9, 1, 46, 28, 878, DateTimeKind.Local).AddTicks(9846), "Kalem 2", 200m, 30, null },
                    { 3, 1, new DateTime(2023, 9, 9, 1, 46, 28, 878, DateTimeKind.Local).AddTicks(9847), "Kalem 3", 600m, 60, null },
                    { 4, 2, new DateTime(2023, 9, 9, 1, 46, 28, 878, DateTimeKind.Local).AddTicks(9896), "Kitap 1", 100m, 20, null },
                    { 5, 2, new DateTime(2023, 9, 9, 1, 46, 28, 878, DateTimeKind.Local).AddTicks(9897), "Kitap 2", 300m, 20, null }
                });
